...
class _EditCompanyInformationState extends State<EditCompanyInformation>
  ...
  Widget buildSafeArea(BuildContext context) {
    return pushUpAnimation( SafeArea(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10,),
                      Text("company_info".tr,style: Theme.of(context).textTheme.displayMedium?.copyWith(
                        fontSize: 18,
                  ...
                  TextFormField(
                      ...
                      decoration: InputDecoration(labelText: 'rne_number'.tr).applyDefaults(Theme.of(context).inputDecorationTheme),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'field_is_required'.tr;
                        }
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: [
                      DropdownMenuItem(value: "male", child: Text('category1'.tr)),
                      DropdownMenuItem(value: "female", child: Text('category2'.tr)),
                    ],
                    onChanged: (value) {
                      _gender = value;
                    },
