              ...
              children: [
                ...
                ValueListenableBuilder(
                  ...
                  builder: (context,loading,_) {
                    return loading ? Center(child: getLoader()) : ElevatedButton(onPressed: () async{

                      if(_formKey.currentState!.validate()){

                        isLoading.value = true;
                        try{
                          await _productController.addProduct(_image!.path, {
                            "name": _productNameController.text,
                            "description": _productDescriptionController.text,
                            "sku":"${_productNameController.text}_${selectedCategory!.id}_${DateTime.now().millisecondsSinceEpoch.toString().substring(0, 10)}",
                            "product_categorie_id": selectedCategory!.id,
                          });
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<LookUpModel>(
                  isExpanded: true,
                  value: list.firstWhereOrNull((item)=>selectedCategory?.id.toString() == item.id.toString()),
